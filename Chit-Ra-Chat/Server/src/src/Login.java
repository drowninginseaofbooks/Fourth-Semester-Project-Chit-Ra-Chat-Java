...
public class Login extends JFrame {
    ...
    public Login()
    {
        ...
        panel.setBorder(BorderFactory.createEmptyBorder(210, 0, 250, 90));
        panel.setAlignmentX(Component.CENTER_ALIGNMENT);

        JTextField emailText = new JTextField("Email");
        emailText.setPreferredSize(new Dimension(300, 50));
        emailText.setHorizontalAlignment(JTextField.CENTER);

        JTextField userText = new JTextField("Username");
        userText.setPreferredSize(new Dimension(300, 50));
